...
const styles = StyleSheet.create({
  ...
  thumbnail: { width: 52, height: 52, borderRadius: 8, backgroundColor: '#DDD' },
  info: { flex: 1, marginLeft: 14 },
  title: { fontSize: 15, fontWeight: '600', color: '#111' },
  artist: { fontSize: 13, color: '#666', marginTop: 2 },
  removeIcon: { fontSize: 16, color: '#CCC', paddingLeft: 8 },
  emptyText: { textAlign: 'center', marginTop: 60, color: '#999', paddingHorizontal: 32 },
});
